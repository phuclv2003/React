          ...
          <div className="container mx-auto">
            <div className="flex pt-12">
              <div className="max-w-[66.6667%] basis-[66.6667%]">
                <div>
                  <div className="shadow-divider-1pt flex px-8 py-3 shadow-[0_0.1px_0_0] bg-white rounded-t-xl">
                    ...
                    <div className="ml-[10px] flex items-center justify-center self-start">
                      ...
                      <div className="css-5gg2ui text-semantic-error ml-[6px]">{data.state === 1 ? 'Đang xử lý' : data.state === 2 ? 'Đã xác nhận' : data.state === 3 ? 'Đang giao' : data.state === 4 ? 'Đã giao' : 'Đã hủy'}</div>
                    </div>
                  </div>
                      ...
                      <div className="flex items-center">
                        <span className="estore-icon  css-wi4pw5">
                          <svg width={20} height={20} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs><linearGradient id="paint0_linear_3708_96166" x1="21.0902" y1="22.5" x2="15.1916" y2="9.09562" gradientUnits="userSpaceOnUse"><stop stopColor="#1250DC"></stop><stop offset="1" stopColor="#306DE4"></stop></linearGradient></defs></svg>
                        </span>
                ...
                <div className=" mt-9">
                  <div className="text-[14px] font-medium text-[#020b27] mb-3">
